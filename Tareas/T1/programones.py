from parametros import AUMENTAR_ATAQUE_FUEGO, AUMENTAR_VELOCIDAD_AGUA, AUMENTAR_VIDA_PLANTA,\
    MAX_ATAQUE, MAX_AUMENTO_ENTRENAMIENTO, MAX_AUMENTO_EXPERIENCIA, MAX_DEFENSA, MAX_EXPERIENCIA,\
    MAX_NIVEL, MAX_VELOCIDAD, MAX_VIDA, MEGA_ATAQUE, MEGA_DEFENSA, MEGA_VELOCIDAD, MEGA_VIDA, \
    MIN_ATAQUE, MIN_AUMENTO_ENTRENAMIENTO, MIN_AUMENTO_EXPERIENCIA, MIN_DEFENSA, MIN_NIVEL, \
    MIN_VELOCIDAD, MIN_VIDA, ORDEN_VENTAJAS, PONDERACIONES_LUCHA
